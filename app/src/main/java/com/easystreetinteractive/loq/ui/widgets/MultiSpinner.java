package com.easystreetinteractive.loq.ui.widgets;
...
// refresh text on spinner
            ...
            for (int i = 0; i < items.size(); i++) {
                if (selected[i] && i<selected.length) {
            ...
            String spinnerText;
            if (someUnselected) {
                spinnerText = spinnerBuffer.toString(); if (spinnerText.length() > 2)
